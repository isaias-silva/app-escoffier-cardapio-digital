# escoffier-cardapio-digital
Nova versão do Escoffier usando meus conhecimentos adquiridos 2 anos depois!

Escoffier é uma aplicação fullstack desenvolvida utilizando as tecnologias Quarkus, Next.js e Postgresql. O principal objetivo do projeto é fornecer uma plataforma para exibição e gerenciamento de cardápios digitais em restaurantes, facilitando a interação entre os clientes e os estabelecimentos.
